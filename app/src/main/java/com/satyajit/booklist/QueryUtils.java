...
public class QueryUtils {
    ...
    public static List<Books> fetchEarthquakeData(String requestUrl){
        ...
        List<Books> booksName = extractFeatureFromJson(jsonResponse);
        return booksName;
    }
    ...
    private static List<Books> extractFeatureFromJson(String booksJSON){
        ...
        try{
            ...
            JSONArray booksItemArray = baseJsonResponse.getJSONArray("items");
            for(int i = 0;i<booksItemArray.length();i++){
                JSONObject currentEarthquake = booksItemArray.getJSONObject(i);
                JSONObject info = currentEarthquake.getJSONObject("volumeInfo");
